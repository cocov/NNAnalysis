...
def make_mini_inception(input_shape):
    ...
    x = normalized_conv2d(image_input, 32, 3, 3, padding='valid') #54,54,32
    x = normalized_conv2d(x,           32, 3, 3, padding='valid') #52,52,32
    x = normalized_conv2d(x,           64, 3, 3)                  #52,52,64
    x = MaxPooling2D((3, 3), strides=(1,1))(x)                    #50,50,64
    
    x = normalized_conv2d(x,           80, 1, 1, padding='valid') #50,50,80
    x = normalized_conv2d(x,          192, 3, 3, padding='valid') #48,48,192
    x = MaxPooling2D((3,3), strides=(2,2))(x)                     #46,46,192
    
    branch1 = normalized_conv2d(x,       64, 1, 1) #5,5,64         46,46,64
    branch5 = normalized_conv2d(x,       48, 1, 1)
    branch5 = normalized_conv2d(branch5, 64, 5, 5) #5,5,64         46,46,64
    branch3 = normalized_conv2d(x,       64, 1, 1)
    branch3 = normalized_conv2d(branch3, 96, 3, 3)
    branch3 = normalized_conv2d(branch3, 96, 3, 3) #5,5,96         46,46,96
    ...
    branch1 = normalized_conv2d(x, 64, 1, 1)
    branch5 = normalized_conv2d(x, 48, 1, 1)
    branch5 = normalized_conv2d(branch5, 64, 5, 5)
    branch3 = normalized_conv2d(x, 64, 1, 1)
    branch3 = normalized_conv2d(branch3, 96, 3, 3)
    branch3 = normalized_conv2d(branch3, 96, 3, 3)
    branchp = AveragePooling2D((3,3), strides=(1,1), padding='same')(x)
    branchp = normalized_conv2d(branchp, 64, 1, 1)
    ...
    branch3 = normalized_conv2d(x, 384, 3, 3, strides=(2,2), padding='valid')
    branch33 = normalized_conv2d(x, 64, 1, 1)
    branch33 = normalized_conv2d(branch33, 96, 3, 3)
    branch33 = normalized_conv2d(branch33, 96, 3, 3, strides=(2,2), padding='valid')
    branchp = MaxPooling2D((3,3), strides=(2,2))(x)
    x = layers.concatenate([branch3, branch33, branchp], axis=3, name='mixed3')
    
    branch1 = normalized_conv2d(x, 192, 1, 1)
    branch7 = normalized_conv2d(x, 128, 1, 1)
    branch7 = normalized_conv2d(branch7, 128, 1, 7)
    branch7 = normalized_conv2d(branch7, 192, 7, 1)
    branch77 = normalized_conv2d(x, 128, 1, 1)
    branch77 = normalized_conv2d(branch77, 128, 7, 1)
    branch77 = normalized_conv2d(branch77, 128, 1, 7)
    branch77 = normalized_conv2d(branch77, 128, 7, 1)
    branch77 = normalized_conv2d(branch77, 192, 1, 7)
    branchp = AveragePooling2D((3,3), strides=(1,1), padding='same')(x)
    branchp = normalized_conv2d(branchp, 192, 1, 1)
    x = layers.concatenate([branch1, branch7, branch77, branchp], axis=3, name='mixed4')
     
    for i in range(2):
        branch1 = normalized_conv2d(x, 192, 1, 1)
        branch7 = normalized_conv2d(x, 160, 1, 1)
        branch7 = normalized_conv2d(branch7, 160, 1, 7)
        branch7 = normalized_conv2d(branch7, 192, 7, 1)
        branch77 = normalized_conv2d(x, 160, 1, 1)
        branch77 = normalized_conv2d(branch77, 160, 7, 1)
        branch77 = normalized_conv2d(branch77, 160, 1, 7)
        branch77 = normalized_conv2d(branch77, 160, 7, 1)
        branch77 = normalized_conv2d(branch77, 192, 1, 7)
        branchp = AveragePooling2D((3,3), strides=(1,1), padding='same')(x)
        branchp = normalized_conv2d(branchp, 192, 1, 1)
    ...
    branch1 = normalized_conv2d(x, 192, 1, 1)
    branch7 = normalized_conv2d(x, 192, 1, 1)
    branch7 = normalized_conv2d(branch7, 192, 1, 7)
    branch7 = normalized_conv2d(branch7, 192, 7, 1)
    branch77 = normalized_conv2d(x, 192, 1, 1)
    branch77 = normalized_conv2d(branch77, 192, 7, 1)
    branch77 = normalized_conv2d(branch77, 192, 1, 7)
    branch77 = normalized_conv2d(branch77, 192, 7, 1)
    branch77 = normalized_conv2d(branch77, 192, 1, 7)
    branchp = AveragePooling2D((3,3), strides=(1,1), padding='same')(x)
    ...
    branch3 = normalized_conv2d(branch3, 320, 3, 3, strides=(2,2), padding='valid')
    branch7 = normalized_conv2d(x, 192, 1, 1)
    branch7 = normalized_conv2d(branch7, 192, 1, 7)
    branch7 = normalized_conv2d(branch7, 192, 7, 1)
    branch7 = normalized_conv2d(branch7, 192, 3, 3, strides=(2,2), padding='valid')
    branchp = MaxPooling2D((3,3), strides=(2,2))(x)
    x = layers.concatenate([branch3, branch7, branchp], axis=3, name='mixed8')
    
    for i in range(2):
        branch1 = normalized_conv2d(x, 320, 1, 1)
        branch3 = normalized_conv2d(x, 384, 1, 1)
        branch31 = normalized_conv2d(branch3, 384, 1, 3)
        branch32 = normalized_conv2d(branch3, 384, 3, 1)
        branch3 = layers.concatenate([branch31, branch32], axis=3, name='mixed9'+str(i))
        
        branch3dbl = normalized_conv2d(x, 448, 1, 1)
        branch3dbl = normalized_conv2d(branch3dbl, 384, 3, 3)
        branch3dbl1 = normalized_conv2d(branch3dbl, 384, 1, 3)
        branch3dbl2 = normalized_conv2d(branch3dbl, 384, 3, 1)
...
if __name__ == '__main__':
    ...
    data   = HDF5Matrix(training_file, 'tracesandtiming')
    ...
    model = make_mini_inception(input_shape=(56, 56, 2))
    ...
    history = model.fit(data, labels, validation_data=[valid_data, valid_labels], 
                        epochs=20, batch_size=100, verbose=2, shuffle='batch', callbacks=[early_stop])
