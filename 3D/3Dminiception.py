...
def make_mini_inception(input_shape):
    ...
    x = normalized_conv3d(image_input, 32, 3, 3, 3, padding='valid') #54,54,23,32
    x = normalized_conv3d(x,           32, 3, 3, 3,  padding='valid')#52,52,21,32
    x = normalized_conv3d(x,           64, 3, 3, 3)                  #52,52,21,64
    x = MaxPooling3D((3, 3, 21), strides=(1,1,1))(x)                    #50,50,19,64
