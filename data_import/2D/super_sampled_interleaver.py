...
if __name__ == '__main__':
    ...
    out_traces = output_file.create_dataset('tracesandtiming', (100, matrix_size, matrix_size, 3), maxshape=(None, matrix_size, matrix_size, 3), dtype='i2')
    ...
    #print(f[f.keys()[0]])
    gamma_data = HDF5Matrix(input_gamma_list[gamma_file_index], 'tracesandtiming')
    proton_data = HDF5Matrix(input_proton_list[proton_file_index], 'tracesandtiming')
