...
srun -u -o /scratch/snx3000/lyard/$output python inceptionV3.py -o $optimizer -l $loss -t 50k_evts_3_chans_square_no_outer_ring.hdf5 -v 1k_evts_3_chans_square_no_outer_ring.hdf5 -s inception_no_ring_$optimizer_$loss.hdf5
