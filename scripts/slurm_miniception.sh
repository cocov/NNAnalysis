...
srun -u -o /scratch/snx3000/lyard/$output python convolution_squashed.py -t /scratch/snx3000/lyard/NNAnalysis-master/50kInterleavedSquash.hdf5 -v /scratch/snx3000/lyard/NNAnalysis-master/1kInterleavedSquash.hdf5 
