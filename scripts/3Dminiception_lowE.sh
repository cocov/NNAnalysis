...
srun -u -o /scratch/snx3000/lyard/results3Dmini/$output python 3Dminiception.py -t /scratch/snx3000/lyard/datasets3D/lowE_training.hdf5 -v /scratch/snx3000/lyard/datasets3D/lowE_validation.hdf5 -s /scratch/snx3000/lyard/models3D/3Dminiception_lowE_epoch16.hdf5 -e 8 -m /scratch/snx3000/lyard/models3D/3Dminiception_lowE_epoch08.hdf5
