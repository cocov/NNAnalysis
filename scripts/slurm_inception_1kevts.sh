...
srun -u -o /scratch/snx3000/lyard/$output python inceptionV3_testing_reload.py -o $optimizer -l $loss -t 1000evts_3_chans_square.hdf5 -v 100evts_3_chans_square.hdf5
